...
public class findsportsDetails extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        sportsDetailsAdapter myAdapter = new sportsDetailsAdapter(findsportsDetails.this, type1,
                                                                  date1, place1);
        ...
        returnbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick (View view) {
                Intent in = new Intent(findsportsDetails.this,
                                       com.example.beachrendezvous.MainActivity.class);
                startActivity(in);
            }
        });
