...
public class MoviesCreateDetails extends Fragment {
    ...
    private static final String TAG = "movies_create_details";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        databaseMovies = FirebaseDatabase.getInstance().getReference(mParam);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if (mParam != null) {
            ...
            view = inflater.inflate(R.layout.fragment_movies_create_details, container, false);
